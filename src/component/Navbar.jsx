...
function Navbar() {
  ...
  return (
      <>
  <nav class="absolute px-2 top-0 mb-10 shadow-lg w-full">
    <div class="md:gap-40 m-1 ml-3 mx-auto flex flex-wrap items-center justify-between">
    ...
    <div class=" hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
      <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 mr-10 md:mt-0 md:text-sm md:font-medium">
        <li>
        ...
        <li>
          <a href="#" class="text-gray-400 mr-96 hover:bg-gray-50 text-decoration-none border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-gray-50 md:p-0"><Link style={{textDecoration:"none",  color:"gray"}} to="/Contact">contact</Link></a>
        </li>
        <li>
        <Button className='justify-center ml-96' variant="primary" href='#signup' onClick={handleShow}>
        Log in
      </Button></li>
      <li>
